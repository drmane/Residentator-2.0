...
* @author Daniel
*/
public class BajaDepartamento extends javax.swing.JFrame implements Vista{
	
	static private BajaDepartamento bajaDepartamento;

	private BajaDepartamento() {
       initComponents();
	}
	 ...
	 */
	static public BajaDepartamento obtenerInstancia(){
		if(bajaDepartamento == null){
			bajaDepartamento = new BajaDepartamento();
		}
   ...
   private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
	   ControladorAplicacionImp.obtenerInstancia().accion(EventoNegocio.BAJA_DEPARTAMENTO, Integer.valueOf(jFormattedTextField1.getText()).intValue());
   }
   ...
   // End of variables declaration
	...
	public void actualizar(int id_evento_vista, Object datos) {
		if(id_evento_vista == EventoVista.BAJA_DEPARTAMENTO_EXITO){
			JOptionPane.showMessageDialog(null, "Se ha dado de baja el departamento con éxito", "Baja Departamento", JOptionPane.INFORMATION_MESSAGE);
		}
